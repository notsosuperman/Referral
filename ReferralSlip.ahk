...
BuildReferralForm()
{
    ...
    ; ===========================================================================
    ; Referral Source and Who Calls
    ; ===========================================================================
    yPos += 10
    Gui, Main:Font, s10 Normal, Arial
    Gui, Main:Add, Text, x20 y%yPos% w115 h22 +0x200, Referral courtesy of:
    Gui, Main:Add, DropDownList, x140 y%yPos% w180 vReferralSource, |Dr. Gabe Proulx|Dr. Curtis Wahlen|Dr. Ben Wolfe|Dr. Jae Lee
    
    Gui, Main:Add, CheckBox, x340 y%yPos% w130 h22 vchkPleaseCallPatient gWhoCallsChanged, Please call patient
    
    yPos += 24
    Gui, Main:Add, CheckBox, x340 y%yPos% w230 h22 vchkPatientWillCall gWhoCallsChanged Checked, Patient will call for appointment
    ...
    Gui, Main:Add, GroupBox, x20 y%yPos% w580 h50, Quick Presets
    Gui, Main:Add, Button, x30 y%yPos%+20 w110 h25 gBtnPresetExtraction, Extraction
    Gui, Main:Add, Button, x150 y%yPos%+20 w110 h25 gBtnPresetImplant, Implant Consult
    Gui, Main:Add, Button, x270 y%yPos%+20 w110 h25 gBtnPresetBiopsy, Biopsy
    Gui, Main:Add, Button, x390 y%yPos%+20 w110 h25 gBtnPresetWisdom, Wisdom Teeth
    
    ; Show the GUI
    Gui, Main:Show, w620 h680
}
...
BtnPresetExtraction:
    GuiControl, Main:, chkExtraction, 1
    GuiControl, Main:, chkDiscussImplants, 1
return

BtnPresetImplant:
    GuiControl, Main:, chkDentalImplants, 1
    GuiControl, Main:, chkConeBeamCT, 1
return

BtnPresetBiopsy:
    GuiControl, Main:, chkBiopsyExcision, 1
    GuiControl, Main:, chkOralPathology, 1
return

BtnPresetWisdom:
    GuiControl, Main:, chkExtraction, 1
    GuiControl, Main:, TeethAreaToTreat, #1, 16, 17, 32
    GuiControl, Main:, chkConeBeamCT, 1
return
